...
import { useContractSubscription } from "@/modules/midnight/shadowkey-sdk/hooks/use-contract-subscription";
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div className="text-center md:text-left">
            <h1 className="text-4xl font-bold text-foreground mb-2">shadowkey Contract</h1>
            <p className="text-xl text-muted-foreground">Interact with the shadowkey smart contract</p>
          </div>
        ...
        <Card className="mb-8">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">shadowkey Contract</CardTitle>
            <CardDescription className="max-w-md mx-auto">
              Deploy and interact with a simple shadowkey smart contract
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <Card>
                  <CardContent className="pt-6">
                    <p className="text-sm font-medium text-muted-foreground mb-1">shadowkey Value</p>
                ...
                <Card>
                  <CardContent className="pt-6">
                    ...
                    <p className="text-2xl font-bold">{derivedState?.privateState.privateshadowkey || '0'}</p>
                  </CardContent>
                </Card>
                <Card>
                  <CardContent className="pt-6">
