...
3. Verify you see:
   ...
   > cd shadowkey-contract && npm run build
...
```
https://your-app.vercel.app/midnight/shadowkey/keys/increment.verifier
```
...
2. Connect wallet
3. Navigate to shadowkey page
4. Try incrementing the shadowkey
...
3. npm run build-production
   ...
   3a. cd shadowkey-contract && npm run build
       → Compiles contract
       → Generates/copies keys to shadowkey-contract/dist/managed/

   3b. cd ../frontend-vite-react && npm run build

       3b.1. npm run copy-contract-keys
             → Copies keys from shadowkey-contract/src/managed/
             → To frontend-vite-react/public/midnight/shadowkey/
