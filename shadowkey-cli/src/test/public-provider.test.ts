...
describe('API', () => {
  ...
  it('public state provider testing', async () => {
    ...
    const contractAddress = shadowkeyContractDeployed.deployTxData.public.contractAddress;
    ...
    const state = shadowkey.ledger(rawState1.data);
    ...
    const state2 = shadowkey.ledger(rawState2.data);
    ...
    const state3 = shadowkey.ledger(rawState3.data);
    ...
    const publicState = shadowkey.ledger(rawState5[1].data);
    ...
    const state7 = shadowkey.ledger(rawState7.data);
    logger.info({ state7 });
